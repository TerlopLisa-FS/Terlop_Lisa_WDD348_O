...
class AnimeThree extends React.Component {
    // Constructor 
    constructor(props) {
        super(props);
  ...
  <div className="card-img-overlay"> 
   <h3 style={styles.h3}>{ items[2].animeTitle }</h3>
   <p>{items[2].subOrDub}</p>
    <a  style={styles.aTag} target="_blank" href={items[2].episodeUrl}> {items[2].episodeUrl}</a>
